...
const smileMessages = [
  ...
  "Warning ⚠️\nExcessive Sweta-ness may cause uncontrollable feelings of admiration.",
  "Congratulations!\nYou have successfully made Varun smile just by existing.",
  "Fun Fact:\nIce cream tastes better when Sweta eats it. And everything looks better next to her.",
  "Sweta has been promoted to:\nChief Executive Officer of Stealing Hearts.",
  ...
  "Plot Twist:\nThe butterflies in everyone's stomach were inspired by Sweta all along.",
  ...
  "Certified Fact:\nSweta's laugh could cure bad days. And it does. Every time.",
  "Scientists baffled:\nSweta somehow gets more stunning every single day.",
  "ANNOUNCEMENT:\nSweta has officially unlocked the 'Has Varun Completely In Awe' achievement.",
  "Fun Fact:\nEverything looks better when Sweta is in it.",
  "Weather Report:\nExpect sunshine, warmth, and 100% chance of good vibes wherever Sweta goes today.",
  ...
  "Daily Reminder:\nSweta is doing better than she thinks. And she's appreciated more than she knows.",
  ...
  "Fun Fact:\nSweta's presence alone has been shown to reduce everyone's stress by 100%.",
  ...
  "Did you know?\nWhenever Sweta laughs, Varun falls a little more in admiration.",
  ...
  "Public Announcement:\nSweta is the kind of person good stories get written about.",
  ...
  "The jury has returned:\nVerdict — Sweta is the best, your honour.",
  "Weather Advisory:\nSweta's energy is expected to cause spontaneous joy.",
  "Did you know?\nSweta has accidentally made Varun smile at his phone 47 times today.",
  "Important Reminder:\nSweta being sad is not allowed. Universe's rules.",
  "Late-Breaking Story:\nSweta is exactly who she's supposed to be — and it's extraordinary.",
  "Update:\nThe ice cream you're about to eat is going to be amazing. Everything is when you're here.",
  "Exclusive:\nSweta's happiness is a priority. Not a maybe. A priority.",
  "Final Report:\nSweta is appreciated more than she will ever fully know. Especially by one particular guy.",
  "BONUS ALERT:\nYou opened this website. That means you are very very loved. Which is a lot."
];
...
// =============================================
const compliments = [
  "Your smile should be illegal for what it does to everyone around you.",
  "You make ordinary days feel like the best days.",
  "You're basically a limited edition. There's only one Sweta.",
  "The stars filed a complaint because you're stealing their sparkle.",
  "Sweta is proof that good things genuinely exist.",
  "You have the kind of laugh that makes people forget everything else.",
  ...
  "Your presence is a gift people don't always deserve but are grateful for.",
  ...
  "Even on your bad days, you're still the most beautiful thing in the room.",
  "You are worthy of every good thing coming your way.",
  "The world is measurably better because you're in it.",
  "You make people feel seen. That's incredibly rare and incredibly you.",
  "You have the ability to turn difficult moments into bearable ones — just by being there.",
  "Your energy is magnetic. People are drawn to you naturally.",
  "You're braver than you believe and more beautiful than you see.",
  "The kindness you give out comes back to you — the universe keeps track.",
  "You are absolutely, undeniably enough. And more than enough.",
  "You carry yourself with a grace you probably don't notice. Others notice everything.",
  ...
  "You're someone people feel unbelievably lucky to have in their corner.",
  ...
  "You're a safe space for people.",
  "You inspire people every day without even knowing it.",
  "Your laugh is genuinely contagious and genuinely the best sound.",
  "You're the kind of person everyone wishes they knew. Varun actually does.",
  ...
  "You're someone worth knowing, Sweta. Truly worth everything.",
  ...
  "You have a warmth people want to be near, always.",
  "You're doing hard things and that deserves recognition.",
  "You have everything it takes to keep going.",
...
const jokes = {
  joke: [
    ...
    "Knock knock.\nWho's there?\nVarun's feelings.\nVarun's feelings who?\nVarun's feelings for Sweta, somehow bigger every day.",
    ...
    "Doctor: I have good news and better news.\nSweta: What's the good news?\nDoctor: The better news is Varun is absolutely floored by you. Medically verified.",
    "Sweta's horoscope today: 'Someone is going to look at you like you hung the moon.'\nEvery horoscope. Every day.",
    "Why did the moon apply for a job?\nBecause it wanted to be as impressive as Sweta.",
    "Sweta opened a fortune cookie.\nIt said: 'Congratulations on being absolutely wonderful.'\nSweta: Oh stop.\nCookie: We cannot.",
  ],
  icecream: [
    "EMERGENCY PROTOCOL ACTIVATED:\nProceed immediately to nearest ice cream source.\nVarun's treat.",
    "Doctor's Orders:\nYou are legally required to eat ice cream at least once today.\nPrescription signed: Dr. Varun (of Admiration).",
    "Scientists discover:\nIce cream consumed while being wonderful makes it 200% better.\nSweta qualifies.",
    ...
    "Fun Fact:\nIce cream tastes 47% better when you're in a good mood. You deserve good moods always.",
    "Diagnosis: Low ice cream levels.\nPrescription: One scoop minimum. Sprinkles mandatory.",
    "The committee has reviewed your week.\nRecommendation: Extra scoop. With sprinkles. Non-negotiable.",
  ],
  confidence: [
    "If confidence were money,\nSweta would own three countries.",
    ...
    "Style check: Passed.\nVibe check: Passed.\nBeing amazing check: Eternally passed.",
  ],
  chaos: [
    "CHAOS MODE ACTIVATED:\nAnything is possible.\nSweta is leading the charge.",
    "Chaotic good:\nSweta, eating ice cream at midnight, not caring, thriving.",
    "Fun chaos idea:\nText someone sweet today.\nWatch them become 300% happier.",
    ...
    "Did you know?\nBeing a little chaotic and a lot wonderful is Sweta's entire brand.",
  ...
  laugh: [
    ...
    "If your laugh were a song, it would be everyone's most-played song.\nFact.",
  ]
};
...
const happyNotes = [
  ...
  "Check in with yourself: are you okay? If not, it's okay to say so.",
  ...
  "Put your phone down for five minutes. You deserve the break.",
  ...
  "Someone's favourite memory involves you.",
  ...
  "You are the sunshine someone has been waiting for.",
...
const dailyQuotes = [
  ...
  "In a world full of people, Sweta stands out every time.",
  ...
  "You are my favourite kind of wonderful.",
...
let climbProgress = 4;
const climbMessages = [
  "Currently stuck behind biryani. Plotting.",
  "Brought ice cream. Still at #4. Worth it though.",
  "Tried playing BTS in the background. Almost worked.",
  "Filed an official complaint. Ice cream rejected it.",
  "Biryani said 'no'. Varun remains determined.",
  "Making progress! Biryani is nervous.",
  "Varun casually mentioned he knows where to get good biryani...",
  "BTS fans voted. Results unclear. Varun hopeful.",
  "Sweta looked at Varun. He counted that as +5 points.",
  "Ice cream is worried. First time in history.",
  ...
  "Varun: 'I will outlast all of them.' Ice cream: 'lol.'",
  "Almost at #3! This might be the year!",
  "Varun overtook BTS! Ice cream and biryani still ahead...",
  "Fighting hard against biryani. It's a tough opponent.",
  "So close to #2! Ice cream remains undefeated but shaking.",
  "TIED WITH ICE CREAM. History being made.",
  "Varun has reached #1! (Ice cream let him. Just this once.)",
];
...
function varunClimbs() {
  ...
  const msgIdx = Math.min(Math.floor(climbProgress / 5), climbMessages.length - 1);
...
function launchConfetti() {
  ...
  for (let i = 0; i < 150; i++) { // Reduced from 220 for mobile
    pieces.push({
...
// =============================================
// BACKGROUND FLOATING ELEMENTS — Mobile-optimised
// More hearts & roses, but fewer total for performance
// =============================================
function initBgElements() {
  const container = document.getElementById('bg-elements');
  const isMobile = window.innerWidth < 768;

  // More hearts/roses, fewer total for mobile perf
  ...
  elements.forEach(({ symbol, count }) => {
    for (let i = 0; i < count; i++) {
      ...
      // Longer, staggered animations = smoother on mobile
      el.style.cssText = `
        left: ${Math.random() * 100}%;
        font-size: ${Math.random() * 1.0 + 0.7}rem;
...
// =============================================
// HEART BURST EFFECT — mobile-friendly smaller burst
// =============================================
